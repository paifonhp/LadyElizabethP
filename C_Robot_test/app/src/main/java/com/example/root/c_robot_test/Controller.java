...
public class Controller extends IOIOActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LED = (ImageView) findViewById(R.id.imageView2);
    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        layoutLeft.setOnTouchListener(new View.OnTouchListener() {
            float speed;
            public boolean onTouch(View arg0, MotionEvent arg1) {
                if(arg1.getAction() == MotionEvent.ACTION_DOWN
                        || arg1.getAction() == MotionEvent.ACTION_MOVE) {
    ...
    class Looper extends BaseIOIOLooper {
        ...
        public void setup() throws ConnectionLostException {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    LED.setImageResource(R.drawable.led01);
                    Toast.makeText(getApplicationContext(),
                            "Connect Robot!", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void disconnected() {
            runOnUiThread(new Runnable() {
                public void run() {
                    LED.setImageResource(R.drawable.led02);
                    Toast.makeText(getApplicationContext(),
                            "Disconnect Robot", Toast.LENGTH_SHORT).show();
                }
            });
        }
